  ...
  if (status === 'accepted') {
    return {
      ...
      text: [
        ...
        '- Top 3 teams may get a coffee chat with a Felicis partner',
        '',
      ...
      html: [
        ...
        '<ul><li>$2,500 Grand Prize</li><li>Meta Ray-Bans (2nd Place)</li><li>Nintendo Switches (3rd Place)</li><li>Free swag + Chipotle for all participants</li><li>Top 3 teams may get a coffee chat with a Felicis partner</li></ul>',
